...
const DB_CONFIG = {
  ...
  password: getEnvVar('DB_PASS', ''),  // Obtener la contraseña de las variables de entorno
...
// Verificar que la contraseña esté definida
if (!DB_CONFIG.password) {
  console.error('❌ ERROR: La contraseña de la base de datos no está definida en las variables de entorno (DB_PASS)');
} else {
