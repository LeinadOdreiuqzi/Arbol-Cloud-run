...
// ============================================
// ADVERTENCIA: Contraseña hardcodeada SOLO para pruebas
// ============================================
const HARDCODED_PASSWORD = 'lI][\\S4B#\\89%Gyf';
console.warn('⚠️  ADVERTENCIA: Usando contraseña hardcodeada - SOLO PARA PRUEBAS  ⚠️');

// Configuración para Cloud SQL
const DB_CONFIG = {
  user: getEnvVar('DB_USER', DB_DEFAULTS.user),
  password: HARDCODED_PASSWORD,  // Contraseña hardcodeada temporalmente
...
console.log('Configuración de base de datos cloud:', {
  ...DB_CONFIG,
  password: '******',  // Contraseña oculta en logs
  usingHardcodedPassword: true  // Indicador de que se está usando contraseña hardcodeada
});
